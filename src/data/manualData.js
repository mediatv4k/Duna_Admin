...
const manualData = [
  ...
  },
  {
    ...
    modulo: "CAJA",
    ruta: "/pos",
    titulo: "Cobro con Pago Móvil: Link para el Cliente y Reporte en Caja",
    resumen: "El cajero no ve datos bancarios: genera un enlace para el cliente y registra la referencia en una pantalla mínima sin scroll.",
    pasos: [
      "En el cobro, elige 'Pago Móvil' como método. La pantalla del cajero muestra solo el total a pagar, el botón '🔗 Copiar Link de Pago' y el reporte de pago.",
      "Pulsa '🔗 Copiar Link de Pago': se crea la transacción y se copia el enlace público (/pago/...) con el mensaje '¡Enlace copiado!'. Compártelo con el cliente (no hay botones de WhatsApp en la caja).",
      "El cliente abre el enlace en su teléfono: ve el total en Bs., los datos bancarios en cuadrícula 2x2 con '📋 Copiar Todo' para pegarlos en su app bancaria, y reporta su número de referencia y banco emisor.",
      "En la caja, cuando el cliente reporta, aparece '✓ El cliente reportó su pago' y la referencia y el banco emisor se autocompletan.",
      "También puedes registrar tú mismo la referencia y el banco emisor (una sola fila) y pulsar 'Confirmar Pago'.",
    ],
    tips: [
      "La referencia no puede repetirse en otra factura: el campo se marca en rojo si ya fue registrada.",
      "Los datos del banco receptor se configuran una vez con 'Configurar datos de cobro' y viajan dentro del enlace.",
      "No se suben capturas ni comprobantes: el pago se valida solo por referencia y banco emisor.",
    ],
    palabrasClave: ["pago movil", "link de pago", "copiar todo", "referencia", "banco emisor", "cobro", "cliente"],
  },
  {
