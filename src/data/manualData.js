...
const manualData = [
  ...
  },
  {
    ...
    modulo: "CAJA",
    ruta: "/pos",
    titulo: "Cobro con Pago Móvil: Link por WhatsApp y Reporte en Tiempo Real",
    resumen: "El cajero envía un link al cliente por WhatsApp; cuando el cliente reporta su referencia, aparece al instante en la caja.",
    pasos: [
    ...
    tips: [
      ...
      "La validación es solo por referencia bancaria y banco emisor: no se suben capturas ni comprobantes.",
      "Los datos del banco receptor se configuran una vez con 'Configurar datos de cobro' y viajan dentro del enlace.",
    ],
    palabrasClave: ["pago movil", "link de pago", "whatsapp", "referencia", "banco emisor", "tiempo real", "reportar pago"],
  },
  {
